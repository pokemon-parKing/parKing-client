...
const getQrCode = async (reservationId) => {
  try {
    const linkToImage = await axios.get(
      `${import.meta.env.VITE_RESERVATION_HOST}/getqr/${reservationId}`
    );
...
const getReservationDetails = async (reservation_id) => {
  ...
  try {
    const { data } = await axios.get(
      `${import.meta.env.VITE_RESERVATION_HOST}/reservations/valet/detail/${reservation_id}`
    );
    return data;
  } catch (error) {
    console.log(error);
...
const getReservationList = async (garage_id, date) => {
  ...
  try {
    const { data } = await axios.get(
      `${import.meta.env.VITE_RESERVATION_HOST}/reservations/valet/list/${garage_id}?date=${date}`
    );
    return data;
  } catch (error) {
    console.log(error);
...
const getSpotMetrics = async (garage_id, date, time) => {
  ...
  try {
    const { data } = await axios.get(
      `${import.meta.env.VITE_RESERVATION_HOST}/reservations/valet/${garage_id}?date=${date}&time=${time}`
    );
    return data;
  } catch (error) {
    console.log(error);
...
const postGenerateQrCode = async (reservationId) => {
  try {
    const response = await axios.post(
      `${import.meta.env.VITE_RESERVATION_HOST}/qr/${reservationId}`
    );
...
const updateStatus = async (status, reservationId) => {
  try {
    await axios.patch(
      `${import.meta.env.VITE_RESERVATION_HOST}/reservations/${reservationId}?status=${status}`
    );
  } catch (error) {
    console.log(error);
  }
