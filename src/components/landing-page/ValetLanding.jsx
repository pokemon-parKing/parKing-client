    ...
    return (
        <main className="m-24"> 
            ...
            <div className='flex justify-between mt-12 ml-36 mr-36'>
              <div className='w-3/12 mt-12 text-center'> 
              {/* w-1/4   */}
                  <div className=' mx-auto  mb-11  h-20 w-20 rounded-full bg-[var(--pk-beige-secondary)] relative'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="-translate-x-1/2 -translate-y-1/2  text-black w-6 h-6 absolute  top-2/4 left-1/2  h-10 w-10">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M12.75 21h7.5V10.75M2.25 21h1.5m18 0h-18M2.25 9l4.5-1.636M18.75 3l-1.5.545m0 6.205 3 1m1.5.5-1.5-.5M6.75 7.364V3h-3v18m3-13.636 10.5-3.819" />
                    </svg>
                  </div>

                  <h2 className='text-xl text-[var(--pk-beige)]'> List Your Garage</h2>
              ...
              <div className='w-3/12 mt-12 text-center'>
                  <div className='valetLP__icons mx-auto  mb-11  h-20 w-20 rounded-full bg-[var(--pk-beige-secondary)] relative'>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="-translate-x-1/2 -translate-y-1/2  text-black w-6 h-6 absolute  top-2/4 left-1/2  h-10 w-10 w-6 h-6">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 0 0 5.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 0 0 9.568 3Z" />
                      <path strokeLinecap="round" strokeLinejoin="round" d="M6 6h.008v.008H6V6Z" />
                      </svg>
                  </div>

                  <h2 className='text-xl text-[var(--pk-beige)]'>Await Reservation Requests</h2>
              ...
              <div className='w-3/12 mt-12 text-center'>
                  ...
                  <h2 className='text-xl  text-[var(--pk-beige)]'>Seamless Transactions</h2>
